  ...
  >
    <n-tab-pane name="order" tab="Order">
      <n-card>
        ...
        <n-divider title-placement="left"> Pelanggan </n-divider>
        <n-descriptions label-class="bg-sfd/60">
          ...
          <n-descriptions-item label="Alamat">
            ...
            RT. {{ cekField(data.data_nasabah.rt) }}/ RW.
            {{ cekField(data.data_nasabah.rw) }}
          </n-descriptions-item>
        </n-descriptions>
      </n-card>
    </n-tab-pane>
      ...
      <n-card>
        <n-descriptions title="Data Survey & Jaminan" label-class="bg-sfd/60">
          ...
          <n-descriptions-item label="Penghasilan Pribadi">
            {{
              cekField(data.data_survey.penghasilan_pribadi).toLocaleString(
                "en-US"
              )
            }}
          </n-descriptions-item>
          <n-descriptions-item label="Penghasilan Pasangan">
            {{
              cekField(data.data_survey.penghasilan_pasangan).toLocaleString(
                "en-US"
              )
            }}
          </n-descriptions-item>
          <n-descriptions-item label="Penghasilan Lainnya">
            {{
              cekField(data.data_survey.penghasilan_lainnya).toLocaleString(
                "en-US"
              )
            }}
          </n-descriptions-item>
        ...
        <n-divider title-placement="left"> Jaminan </n-divider>
