<template>
  <n-card>
    ...
    <div
      title="PK"
      v-show="prosesPK"
      class="flex gap-2 justify-end border-t p-4"
    >
      ...
      <div class="flex flex-col min-w-[900px] p-10" ref="pk">
        ...
        >
          <table border="1" class="mb-10">
            <tr>
              <td align="center">PERJANJIAN PEMBERIAN PINJAMAN</td>
            </tr>
            <tr>
              <td align="center">
              ...
              <td>
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td valign="top">:</td>
                    <td>
                      <span class="capitalize">{{ pihak1.alamat }}</span>
                    </td>
                  </tr>
                </table>
              </td>
        ...
        <div class="mt-2" v-show="optPrint.tandaTerima">
          <div class="bg-white max-w-[900px] shadow-lg p-8">
            ...
            <div class="mb-4">
              <table>
                ...
                <tr>
                  ...
                  <td width="25">:</td>
                  <td>
                    <b class="uppercase">{{ pihak1.alamat }}</b>
                  </td>
                </tr>
              </table>
            </div>
            <div class="mb-4 text-justify text-sm">
              ...
              <b>{{ dayFull.date }}</b> bulan <b>{{ dayFull.month }}</b> tahun
              <b>{{ dayFull.year }}</b
              >,Dengan ini telah menerima buku kepemilikan kendaraan (BPKB) dalam keadaan baik dengan rincian sebagai berikut :
            </div>
            <div class="mb-4 text-justify">
              <table>
                <tr>
