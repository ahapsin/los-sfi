    ...
    <n-tabs type="line" animated>
      ...
      <template #suffix>
        <n-popconfirm :show-icon="false">
          ...
          ></n-input>
          <template #action>
            <n-button type="primary" secondary @click="handlePositiveClick"
              >Setuju</n-button
            >
            <n-button secondary type="warning" @click="handleTrashClick">
                Revisi
            </n-button>
            <n-button secondary type="error" @click="handleNegativeClick"
              >Tolak</n-button
            >
          </template>
        </n-popconfirm>
