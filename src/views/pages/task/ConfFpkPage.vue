        ...
        <n-tabs type="line" animated>
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <n-form-item label="Provisi" path="provisi">
                            <n-input-number :parse="parse" :format="format" v-model:value="calcCredit.provisi"
                                placeholder="Provisi" :show-button="false" class="flex !w-full" readonly />
                        </n-form-item>
                        <n-form-item label="Asuransi" path="asuransi">
                            <n-input-number :parse="parse" :format="format" v-model:value="calcCredit.asuransi"
                                placeholder="Asuransi" :show-button="false" class="flex !w-full" readonly />
                        </n-form-item>
                        ...
                        <n-form-item label="Bunga / Margin Flat" path="bunga_margin_flat">
                            <n-input v-model:value="calcCredit.bunga_flat" placeholder="Bunga / Margin Flat" readonly />
                        </n-form-item>
                    </div>
                    <div class="flex flex-col w-full">
                        <n-form-item label="Bunga / Margin" path="bunga_margin">
                            <n-input-number :parse="parse" :format="format" v-model:value="calcCredit.bunga_margin"
                                placeholder="Bunga / Margin" :show-button="false" class="flex !w-full" readonly />
                        </n-form-item>
                        <n-form-item label="Pokok + Margin" path="pokok_margin">
                            <n-input-number :parse="parse" :format="format" v-model:value="calcCredit.pokok_margin"
                                placeholder="Pokok + Margin" :show-button="false" class="flex !w-full" readonly />
                        </n-form-item>
                        <!-- <n-form-item label="Angsuran Terkahir" path="angsuran_terakhir">
                            <n-input-number :parse="parse" :format="format" v-model:value="calcCredit.angsuran_terakhir"
                                placeholder="Angsuran Terakhir" :show-button="false" class="flex !w-full" readonly />
                        </n-form-item> -->
            ...
            <template #suffix>
                <n-popconfirm :show-icon="false" @positive-click="handlePositiveClick" positive-text="konfirmasi"
                    negative-text="reject" @negative-click="handleNegativeClick">
                    <template #activator>
...
const calcCredit = reactive({
    ...
    angsuran: computed(() => (Math.round((calcCredit.pokok_pembayaran + calcCredit.bunga_margin) / calcCredit.periode / 1000) * 1000)),
