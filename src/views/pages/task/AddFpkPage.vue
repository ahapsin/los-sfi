<template>
    ...
    <n-spin :show="suspense">
                        ...
                        <div class="p-4 pb-0">
                            <div class="flex gap-2">
                                ...
                                <n-form-item label="Nama Penjamin" path="nama_kerabat" class="w-full">
                                    <n-input placeholder="Nama penjamin" v-model:value="penjamin.nama"  @input="$event => (penjamin.nama = $event.toUpperCase())" />
                                </n-form-item>
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <n-form-item label="Telepon" path="telepon">
                                    <n-input placeholder="Telepon Sellular 1" v-model:value="penjamin.no_hp" maxlength="13" :allow-input="onlyAllowNumber"/>
                                </n-form-item>
                                <n-form-item label="Pekerjaan" path="nama">
                                    <n-input placeholder="Pekerjaan Penjamin" v-model:value="penjamin.pekerjaan"  @input="$event => (penjamin.pekerjaan = $event.toUpperCase())">
                                    </n-input>
                                </n-form-item>
                            </div>
                            <n-form-item label="Alamat" path="nama_kerabat" class="w-full">
                                <n-input :autosize="{
                  minRows: 3,
                }" type="textarea" placeholder="Alamat" v-model:value="penjamin.alamat"  @input="$event => (penjamin.alamat = $event.toUpperCase())"/>
                            </n-form-item>
                        </div>
                    </div>
                    <n-divider title-placement="left">
                    ...
                    <div class="flex gap-2">
                        <n-form-item label="Nama Kerabat" path="nama_kerabat" class="w-full">
                            <n-input placeholder="Nama Kerabat" v-model:value="dataKerabat.nama"  @input="$event => (dataKerabat.nama = $event.toUpperCase())"/>
                        </n-form-item>
                        <n-form-item label="Telepon" path="telepon" class="w-full">
                            <n-input placeholder="Telepon Selular" v-model:value="dataKerabat.no_hp" maxlength="13" :allow-input="onlyAllowNumber"/>
                        </n-form-item>
                    </div>
                    <n-form-item label="Alamat" path="alamat">
                        <n-input-group>
                            <n-input placeholder="Alamat" v-model:value="dataKerabat.alamat"  @input="$event => (dataKerabat.alamat = $event.toUpperCase())"/>
                            <n-input placeholder="RT" v-model:value="dataKerabat.rt" maxlength="3" :allow-input="onlyAllowNumber"/>
                            <n-input placeholder="RW" v-model:value="dataKerabat.rw" maxlength="3" :allow-input="onlyAllowNumber"/>
                        </n-input-group>
                    </n-form-item>
                    ...
                    <n-form-item label="Kode Pos" path="kodepos">
                        <n-input placeholder="Kode Pos" v-model:value="dataKerabat.kode_pos" maxlength="5" :allow-input="onlyAllowNumber"/>
                    </n-form-item>
        ...
        footer: 'soft',
                ...
                <n-form ref="formEkstra" :model="calcCredit" :rules="rulesExtra"
                    :label-placement="width <= 920 ? 'top' : 'top'" require-mark-placement="right-hanging"
                    label-width="auto" :disabled="viewMode">
