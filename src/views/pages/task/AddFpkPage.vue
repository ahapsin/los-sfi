    ...
    <n-flex class="pt-2">
      <n-card v-show="current == 1" title="Informasi pelanggan" :segmented="{
        ...
        <n-form ref="formPelangganAlamatIdentitas" :model="alamatIdentitas" :rules="rulesIdentitas" :disabled="viewMode"
          ...
          <div class="flex gap-2">
            ...
            <n-form-item label="RT" path="rt">
              <n-input placeholder="RT" v-model:value="alamatIdentitas.rt" :allow-input="onlyAllowNumber" :maxlength="3"
                @input="$event => (alamatIdentitas.rt = $event.toUpperCase())">
              </n-input>
            </n-form-item>
            <n-form-item label="RW" path="rw">
              <n-input placeholder="RW" v-model:value="alamatIdentitas.rw" :allow-input="onlyAllowNumber" :maxlength="3"
        ...
        <n-form ref="formPelangganAlamatTagih" :model="alamatTagih" :rules="rulesAlamatTagih" :disabled="viewMode"
          ...
          <n-form-item label="Kode Pos" path="kode_pos">
            <n-input placeholder="Kode Pos" v-model:value="alamatTagih.kode_pos" :allow-input="onlyAllowNumber"
              maxlength="5" />
          </n-form-item>
      ...
      <n-card v-show="current == 2" title="Informasi Order" :segmented="{
        ...
        <n-form ref="formOrder" :model="dataOrder" :rules="rulesOrder" :label-placement="width <= 920 ? 'top' : 'top'"
          ...
          <n-form-item label="Catatan Survey" path="catatan_survey">
            <n-input type="textarea" show-count @input="$event => (dataOrder.catatan_survey = $event.toUpperCase())"
          ...
          <div class="flex gap-2">
            <n-form-item label="Nama Ibu Kandung" path="nama_ibu" class="w-full">
              <n-input placeholder="Nama Ibu Kandung" @input="$event => (dataOrder.nama_ibu = $event.toUpperCase())"
          ...
          <n-form-item label="No NPWP" path="no_npwp">
            <n-input placeholder="No NPWP" v-model:value="dataOrder.no_npwp" :allow-input="onlyAllowNumber" />
          </n-form-item>
            ...
            <div class="p-4 pb-0">
              <div class="flex gap-2">
                <n-form-item label="No KTP" path="nama_kerabat" class="w-full">
                  <n-input placeholder="KTP Penjamin" v-model:value="penjamin.no_identitas" show-count :maxlength="16"
                    :allow-input="onlyAllowNumber" />
                </n-form-item>
              ...
              <div class="grid grid-cols-3 gap-2">
                ...
                <n-form-item label="Telepon" path="telepon">
                  <n-input placeholder="Telepon Sellular 1" v-model:value="penjamin.no_hp" maxlength="13"
                    :allow-input="onlyAllowNumber" />
                </n-form-item>
      ...
      <n-card v-show="current == 4" title="Data Ekstra" :segmented="{
        ...
        <n-form ref="formExtra" :model="calcCredit" :rules="rulesExtra" :label-placement="width <= 920 ? 'top' : 'top'"
          require-mark-placement="right-hanging" label-width="auto" :disabled="viewMode">
...
console.log(computForm);
  ...
  //   }
  //   router.push("/task/apply-credit");
  //   message.push(`data berhasil dikirim`);
  // } else {
