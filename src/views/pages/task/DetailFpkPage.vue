<template>
    <n-card class="mt-2" title="Pengajuan Kredit" @close="handleClose" :segmented="true">
        <template #header-extra>
            <black-list v-if="!approval.status.charAt(0)" />
        </template>
        <div class="p-2 flex gap-2">
            <div class="border p-2 rounded-lg w-full shadow" v-show="approval.kapos">
                <div class="flex gap-2">
                    <n-icon size="20"><message-icon /></n-icon> <b>KAPOS</b>
                </div>
                {{ approval.kapos }}
            </div>
            <div class="border p-2 rounded-lg w-full" v-show="approval.ho">
                <div class="flex gap-2">
        ...
        <n-form ref="formRef" :model="model" label-placement="left" :label-width="160" :disabled="true"
            >
                ...
                <n-tab-pane name="order" tab="Order">
                    <div class="flex gap-2">
                        <n-form-item label="Tanggal Order" path="order" class="w-full">
                            <n-input placeholder="Tanggal order" v-model:value="dataOrder.order_tanggal"
                                class="w-full" />
                        </n-form-item>
                ...
                <n-tab-pane name="tambahan" tab="Tambahan">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <n-form-item label="No KTP" path="nama_kerabat" class="w-full">
                            <n-input placeholder="KTP Penjamin" v-model:value="dataPenjamin.no_identitas" show-count
                                :maxlength="16" />
                        </n-form-item>
