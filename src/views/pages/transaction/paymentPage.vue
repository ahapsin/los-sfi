    ...
    <n-card>
        ...
        <div>
            ...
            <n-data-table striped size="small" :row-key="(row) => row.loan_number" :columns="columns"
                :data="dataPayment" :max-height="300" :on-update:checked-row-keys="handleFasilitas"
    ...
    <n-modal class="w-1/2" title="Upload Berkas Pencairan" v-model:show="showModal">
        <n-card :bordered="false" aria-modal="true">
            ...
            <div class="flex justify-between">
                <div>
                    <div class="flex">
                        <label class="w-24">Tanggal</label><span>
                            <n-text strong> {{ bodyModal.tgl_transaksi }}</n-text></span>
                    </div>
                    <div class="flex">
                        <label class="w-24">No Transaksi</label><span>
                            <n-text strong> {{ bodyModal.no_transaksi }}</n-text></span>
                    </div>
                    <div class="flex">
                        <label class="w-24">Atas Nama </label><span>
                    ...
                    <div class="flex">
                        <label class="w-24">Total Bayar</label><span>
