  ...
  >
    ...
    >
      ...
      <n-form-item label="Deskripsi">
        <n-input
          type="textarea"
          v-model:value="dynamicForm.descr"
      ...
      <div class="flex gap-2">
        <n-form-item
          label="Minimal"
          path="tahun_kendaraan"
          :rule="rules.tahun_jaminan"
        >
          <n-date-picker
            value-format="yyyy"
            v-model:formatted-value="dynamicForm.min_year"
            type="year"
            placeholder="Tahun jaminan"
            clearable
          />
        </n-form-item>
        <n-form-item
        ...
        >
          <n-date-picker
            value-format="yyyy"
            v-model:formatted-value="dynamicForm.max_year"
            type="year"
            placeholder="Tahun jaminan"
            clearable
            :on-blur="maxYear"
